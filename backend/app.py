...
from guide_routes import guides_router
from itinerary_routes import itinerary_router      # ← Member 5
...
app.register_blueprint(guides_router)
app.register_blueprint(itinerary_router)           # ← NEW
